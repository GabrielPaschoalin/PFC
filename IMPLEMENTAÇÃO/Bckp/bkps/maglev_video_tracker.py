...
# -*- coding: utf-8 -*-
"""
MAGLEV VIDEO TRACKER V23 - SIMPLE DARK-BLOB TOP TRACKER + PRE-CONTOUR PHYSICAL MASK
...
def process_video(video_path: str, output_dir: str, p: Params):
    ...
    print("MAGLEV VIDEO TRACKER V23")
...
def make_plot(df: pd.DataFrame, out_path: str):
    ...
    ax.set_title(f"Maglev video tracking V23 | time_conf={time_conf}")
...
def main():
    ...
    ap.add_argument("--output-dir", default=None, help="Pasta de saida. Default: nome do video + _v23")
    ...
    output_dir = args.output_dir if args.output_dir else f"{stem}_v23"
