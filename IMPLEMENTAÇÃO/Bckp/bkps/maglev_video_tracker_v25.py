...
# -*- coding: utf-8 -*-
"""
MAGLEV VIDEO TRACKER V25 - SIMPLE DARK-BLOB TOP TRACKER + TRACKING OVERLAY VIDEO LEGEND AT BOTTOM
...
def process_video(video_path: str, output_dir: str, p: Params):
    ...
    print("MAGLEV VIDEO TRACKER V25")
...
def make_plot(df: pd.DataFrame, out_path: str):
    ...
    ax.set_title(f"Maglev video tracking V25 | time_conf={time_conf}")
