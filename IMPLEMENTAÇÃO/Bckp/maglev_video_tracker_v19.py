...
# -*- coding: utf-8 -*-
"""
MAGLEV VIDEO TRACKER V19 - SIMPLE DARK-BLOB TOP TRACKER + FIXED ZERO RULER
...
def process_video(video_path: str, output_dir: str, p: Params):
    ...
    print("MAGLEV VIDEO TRACKER V19")
...
def make_plot(df: pd.DataFrame, out_path: str):
    ...
    ax.set_title(f"Maglev video tracking V19 | time_conf={time_conf}")
...
def main():
    ...
    ap.add_argument("--ball-crop-ymax-ratio", type=float, default=None, help="Crop vertical opcional da busca da bolinha. Ex: 0.70 mantem os 70%% superiores do frame")
    ap.add_argument("--ball-crop-ymin-ratio", type=float, default=None, help="Inicio vertical opcional da busca da bolinha. Default: 0.0")
    ...
    output_dir = args.output_dir if args.output_dir else f"{stem}_v19"
