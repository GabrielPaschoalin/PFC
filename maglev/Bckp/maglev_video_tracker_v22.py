...
# -*- coding: utf-8 -*-
"""
MAGLEV VIDEO TRACKER V22 - SIMPLE DARK-BLOB TOP TRACKER + PHYSICAL GATES
...
def process_video(video_path: str, output_dir: str, p: Params):
    ...
    print("MAGLEV VIDEO TRACKER V22")
...
def make_plot(df: pd.DataFrame, out_path: str):
    ...
    ax.set_title(f"Maglev video tracking V22 | time_conf={time_conf}")
...
def main():
    ...
    ap.add_argument("--output-dir", default=None, help="Pasta de saida. Default: nome do video + _v22")
    ...
    output_dir = args.output_dir if args.output_dir else f"{stem}_v22"
