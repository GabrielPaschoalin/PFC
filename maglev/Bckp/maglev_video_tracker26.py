...
# -*- coding: utf-8 -*-
"""
MAGLEV VIDEO TRACKER V26 - ORGANIZED OUTPUTS + COMPACT TREATED CSV
...
Exemplo:
    python maglev_video_tracker_v26.py --video video.mp4 --output-dir saida_v26
"""
...
def process_video(video_path: str, output_dir: str, p: Params):
    ...
    print("MAGLEV VIDEO TRACKER V26")
...
def main():
    ...
    output_dir = args.output_dir if args.output_dir else f"{stem}_v26"
